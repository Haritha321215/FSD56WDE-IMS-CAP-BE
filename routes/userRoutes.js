...
userRouter.put("/profile",  auth.verifyToken, auth.isAdmin,userController.updateUser); // protected-user needs to be authenticated
userRouter.delete("/profile",  auth.verifyToken, auth.isAdmin, userController.deleteUser); // protected-user needs to be authenticated
